...
export default function NotFound() {
  ...
  return (
    ...
    <header className="flex flex-col h-screen items-center justify-center">
            ...
            <img src={logo} alt="logo"  className="w-16 cursor-pointer hover:drop-shadow-2xl"/>
    ...
    <div className="pt-5">
        ...
        <p className='mt-4 '>Go to the <NavLink to="/" className='p-2 ml-2 bg-red-500 rounded-lg'>HomePage</NavLink></p>
    </div>
        </header>      
    </>
  )
