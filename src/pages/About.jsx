export default function About() {
  const img1 =
    "https://live.staticflickr.com/65535/53377074511_95c72455ac_w.jpg";
  const img2 =
    "https://live.staticflickr.com/65535/53377393939_c0029d3246_w.jpg";
  return (
    <main>
      <div
        className="about  w-full grid gap-12 lg:gap-0 lg:flex lg:justify-between  py-20 px-5 pr-20"
        id="about"
      >
        <div className="left lg:text-start  text-center grid justify-center ">
          ...
          <p className=" lg:w-[410px] sm:w-[440px] w-[370px]  text-aboutText text-base  pt-5  ">
            I love to design and build engaging user interfaces in both web and
            mobile apps. I was a Graphic Designer before I started to learn
            about the world of software development, since then I have been
            practicing everyday, building, breaking and then fixing what I
            broke. I learn by doing and I love to learn and try new
            technologies. I find making websites and mobile apps very fun, and
            I'm always up to try and get better at it.
          </p>
        ...
        <div className="right grid sm:flex justify-between gap-0 sm:gap-10">
          <div className="first group overflow-hidden relative  border rounded-lg border-borderColor h-[385px] w-[350px] sm:w-[300px] lg:w-[250px] pt-12  flex flex-col  shadow-lg duration-500 transform transition-transform hover:-translate-y-2 items-center text-center  ">
            ...
            <h4 className="text-2xl font-bold text-text-Black pt-5 tracking-wider">
              Design Toolkit
            </h4>
